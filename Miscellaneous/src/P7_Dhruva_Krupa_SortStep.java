...
/**
 * Driver program for the P7_Dhruva_Krupa_Sorts class.
 *
 * <p>modified by Jason Quesenberry and Nancy Quesenberry January 16, 2006
 *
 * @author G. Peck
 * @created July 18, 2002
 */
public class P7_Dhruva_Krupa_SortStep {
    private Scanner console;
    private ArrayList<Comparable> myArray;
    private P7_Dhruva_Krupa_Sorts mySorts;
    private String listType;

    /** Constructor for the P7_Dhruva_Krupa_SortStep object */
    public P7_Dhruva_Krupa_SortStep() {
        console = new Scanner(System.in);
        mySorts = new P7_Dhruva_Krupa_Sorts();
        myArray = null;
        listType = "Integer";
    }

    public static void main(String[] args) {
        P7_Dhruva_Krupa_SortStep s = new P7_Dhruva_Krupa_SortStep();
        s.sortMenu();
    }

    /**
     * Asks the user to select a sorting algorithm, fills the array with an amount of random integer
     * data chosen by the user, calls the sorting algorithm, and gives an option of printing out the

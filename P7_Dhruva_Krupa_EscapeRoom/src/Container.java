...
public class Container extends Item implements CommandHandler {
        ...
        for (Item i : contents) {
            if (i.getName().equals(item.getName())) {
                throw new IllegalArgumentException(
                        getName() + " already contains a " + item.getName());
            }
        }
        contents.add(item);
    }
    ...
    /**
     * returns list containing the contents of the container. Modifying this list has no effect on
     * the underlying list of items contained in the container because it is a different list.
     *
    ...
    /**
     * returns the item with the given name contained in the container, or null if no such item
     * exists.
     *
     * @param itemName the name of the item to return
     * @return the item with the given name contained in the container, or null if no such item
     *     exists.
     */
    ...
    /**
     * Adds the contents of the container to the room this container is in. This is a helper method
    ...
    /**
     * Removes the contents of the container from the room the container is in. This is a helper
     * method called by the close() method.
     */
    ...
    /**
     * sets the room the container is in and if the container is open, this adds the contents to the
     * room.
     */
    @Override

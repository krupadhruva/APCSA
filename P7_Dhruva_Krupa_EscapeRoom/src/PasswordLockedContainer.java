public class PasswordLockedContainer extends Container {
    ...
    /**
     * Creates a password locked container with the given name, description, open state, locked
     * state, and password to unlock the container.
     *
     * @param name the name of the container
     * @param description the description of the container
     ...
     * @param password the password to unlock the container
     */
    public PasswordLockedContainer(
            String name, String description, boolean isOpen, boolean isLocked, String password) {
        super(name, description, isOpen, isLocked);
        this.password = password;
    }

    /**
     * Called when the password is entered successfully. Prints a message reporting the success and
     * then unlocks the container. This could be overridden by subclasses to customize the message
    ...
    /**
     * Called when an incorrect password is entered. Prints a message reporting the failure. This
     * could be overridden by subclasses to customize the message and/or add additional effects.
     */
    ...
    /**
     * The message to print when prompting the user for the password. This could be overridden by
     * subclasses to customize the prompt.
     *
     * @return
     */

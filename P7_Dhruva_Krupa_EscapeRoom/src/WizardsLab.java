public class WizardsLab extends Room {
    ...
    public WizardsLab(String description, String intro, int maxTurns) {
        ...
        Container chest =
                new PasswordLockedContainer(
                        "silver_chest",
                        "a silver chest decorated with pictures of locusts.",
                        "hocus pocus");
        ...
        add(chest);
        TextItem scrapOfPaper =
                new TextItem(
                        "scrap_of_paper",
                        "a scrap of paper with an unfinished limerick scrawled on it.",
    ...
    public void onEscaped() {
        System.out.println(
                "Using the gold key, you open the magical door and escape to freedom!"
                    + " Congratulations, you have escaped in "
                        + numTurns
                        + " turns!");
    }
